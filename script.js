...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (isShopPage) {
        ...
        productItems.forEach(item => {
            ...
            // Permanently hide descriptions
            description.style.display = 'none';
            
            // Prevent description click from navigating (just in case)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(event) {
        ...
        if (!isClickInsideMenu && !isClickOnHamburger && navMenu && navMenu.classList.contains('show')) {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            // Clear 'clicked' class from all links
            navLinks.forEach(l => l.classList.remove('clicked'));
            
            // Add 'clicked' class to the clicked link
            this.classList.add('clicked');
            
            // Store the clicked state in localStorage to persist between pages
            localStorage.setItem('lastClickedNav', this.getAttribute('href'));
    ...
    // Check if there's a stored clicked nav item and apply the class
    const lastClickedNav = localStorage.getItem('lastClickedNav');
    if (lastClickedNav) {
        const currentPageLink = document.querySelector(`nav a[href="${lastClickedNav}"]`);
        if (currentPageLink) {
            currentPageLink.classList.add('clicked');
        }
    }
